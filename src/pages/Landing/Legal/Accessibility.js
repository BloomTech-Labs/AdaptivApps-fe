    ...
    <div className={classes.root}>
      ...
      <div>
        ...
        <p>
          ...
          people with disabilities. adaptivdev.net has invested a significant
        ...
        <p>
          The adaptivdev.net accessibility menu can be enabled by clicking the
        ...
        <h2>Disclaimer</h2>
        <p>
          adaptivdev.net continues its efforts to constantly improve the
        ...
        <p>
          Despite our efforts to make all pages and content on adaptivdev.net
        ...
        <h2>Here For You</h2>
        <p>
          If you are experiencing difficulty with any content on adaptivdev.net
        ...
        <p>
          ...
          need assistance, please contact adaptivdev.net Customer Support as
          follows:
        </p>
