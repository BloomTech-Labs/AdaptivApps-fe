  ...
  return (
    <main className={classes.main}>
      ...
      <p>
        ...
        control the duration of such downtime. Reasonable efforts are taken t
        ...
        within our Web App, including any User Content, a appropriate or are
      ...
      <p>
        ...
        MATERIALS CONTAINED ON THE MOBIL APP ARE ALL PROVIDED “AS IS”, “AS
        AVAILABLE” AND “WITH ALL FAULTS.” ANGEL CITY SPORTS AND ITS AFFILIATES
        MAKE NO REPRESENTATION OR WARRANTY WHATSOEVER REGARDING THE COMPETENESS,
        ACCURACY, CURRENTCY, OR ADEQUACY OF, OR THE SUITABILITY, FUNCTIONALITY,
        AVAILABILITY, OR OPERATION OF OUR WEB APP OR THE INFORMAITON OR
        MATERIALS IT CONTAINS. THE FULLEST EXTENT PERMISSIBLE UNDER APPLICABLE
        LAW, ADAPTIVE APPS AND ITS RESPECTIVE AFFILIATES SPECIFICALLY DISCLAIM
        ALL WARRANTIES, EXPRESS OR IMPLIED WITH RESPECT TO OUR MOBIL APP, THE
        CONTENT AND THE INFROMATION AND MATERIALS CONTAINED ON OUR WEB APP,
        ...
        DEALING OR USAGE IN TRADE. ADAPTIV APPPS AND ITS AFFILIATES TO NOT MAKE
        ANY WARRANT OR REPRESENTATION RGARDING (1) THE RESULTS THAT MAY BE
        OBTAINED FROM USE OF OUR WEB APPP OR THE CONTENT, INFORMATION, SERVICES
        AND RELATED MATERIALS CONTAINED ON THEWEB APP, (2) ANY CONTENT OBTAINED
        FROM OUR WEB APP OR THE CONTENT, INFORMATION, SERVICES AND RELATED
        MATERIALS CONTAINED ON THE MOBIEL APP, OR (III) THE ACCURACY OR
        RELIABILTY OF ANY CONTENT OBTAINED FROM OUR WEB APP OR THE CONTENT,
        ...
        INTERRUPTIONS AND DLEAYS INHERING IN THE INTERNET COMMUNICATIONS. YOU
        RECOGNIZE THAT PROBLEMS WITH THE INTERNET, INCLUDING EQUIPMENT, SOFTWARE
        AND NETWORK FAILURES, IMPAIRMENT OR CONGESION OR THE CONFIGURAITON OF
        YOUR COMPUTER SYSTEMS MAY PREVENT, INTERRUPT OR DELAY YOUR ACCESS TO OUR
        WEB APP. ANGEL CITY SPORTS IS NOT LIABLE FOR ANY DELAYS, INERRUPTIONS,
        SUSPENSIONS OR UNABILIABILITY OF OUR WEB APP, OR ANY PORTION OR OUR WEB
        APP, ATTRIBUTABLE TO PROBLEMS WITH THE INTERNET OR CONFIGUARION OF YOUR,
        YOUR CHILD’S OR THE PERSON’S TO WHOM YOU ARE A GUARDIAN COMPUTER
        SYSTEMS. THER IS NO WARARNTY AS TO OUR WEB APP OR ANY PRODUCT, SERVICE
        ...
        IMPLIED WARRANTIES, SO THE ABOVE EXLCUSE MAY NOT APPLY TO YOU.
      </p>
      <h4>10. LIMITATION OF LIABILITY</h4>
      <p>
        TO THE EXTENT ALLOWS BY LAW, IN NO EVENT WILL ANGEL CITY SPORTS OR ANY
        OF OUR OR THEIR RESPECTIVE VENDORS, AFFILIATES, OFFICEWRS, MEMBERS,
        REPERESENTATIVES, SUPPLIERS, DIRECTORS, EMPLYEES, CONSULTANTS, OWNERS,
        OR AGENTS BE LIABILITY FOR DAMAGES OF ANY KIN, INCLUDING WITHOUT
        LIMITATION ANY DAMAGES FOR LOSS OF US, DATA, IFNORMATION, PROFITS,
        BUSINESS, REVENUE, EXPECTED SAVINGS OR BUSINESS INTERRUPTION, OR ANY
        DIRECT, SPECIAL, INDIRECT, INCIDENTIAL, EXEMPLARY, PUNITIVE OR
        CONSEQUENTIAL DAMAGES ARISING FROM OR OTHERWISE RELATED TO (1) OUR MOBIL
        APP, (2) THE USE OR PERFORMANCE OF OUR WEB APP OR ANY LINED WEBSITE OR
        ANY CONTENT OR OTHER MATERIAL OR INFOMRAITON OBTAINED THROUHG OR WEB
        APP, OR (3) OTHERWISE ARISING OUT OF THE USE OR INABILITY TO USE OUR WEB
        APP OR THE OCNTENT, INFORMATION, SERVICES AND RELATED MATERIALS
        CONTAINED ON THE WEB APP, WHETHER SUCH DAMAGES ARE BASED IN TORT,
        CONTRACT, NEWGLIGENCE, STRICT LIABILTY OR OTHERWISE, EVEN IF ANGEL CITY
        SPORTS HAS BEEN ADVISED OF THE POSSIBLITY OF SUCH DAMAGES OR SUCH
        ...
        EVENT, THE AGGREGATE LIABITY OF ADAPTIVE APPS AND OUR AFFILAITES AND
        VENDORS FOR ANY REASON SHALL NOT EXCEED $100.00 US DOLLARS, EVEN IF SUCH
        REMEDY SHOULD FAIL F ITS ESSENTIAL PURPOSE.
      </p>
      ...
      <ol type="a">
        <li>
          Entire Agreement. This EULA constitute the entire agreement between
        ...
        <li>
          ...
          significant. The words “include”, “including” and all other forms
