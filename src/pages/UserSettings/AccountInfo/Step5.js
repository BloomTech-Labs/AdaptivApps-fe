  ...
  return (
    <form className={classes.root} onSubmit={handleSubmit(onSubmit)}>
      ...
      <Controller
        ...
        defaultValue=""
      />
      <InputLabel htmlFor="ethnicity" className={classes.spacing}>Please enter your ethnicity</InputLabel>
      <Controller
        as={<TextField />}
        name="ethnicity"
        variant="outlined"
      ...
      <Controller
        ...
        defaultValue=""
      />
      <InputLabel htmlFor="employment" className={classes.spacing}>Are you currently employed?</InputLabel>
      <Controller
        as={
          <Select>
            <MenuItem value="Yes">Yes</MenuItem>
        ...
        defaultValue=""
      />
      <InputLabel htmlFor="favProAthletes" className={classes.spacing}>Who are your favorite professional athletes?</InputLabel>
      <Controller
        as={<TextField />}
        name="favProAthletes"
        variant="outlined"
        ...
        defaultValue=""
      />
      <InputLabel htmlFor="favCelebs" className={classes.spacing}>Who are your favorite celebrities?</InputLabel>
      <Controller
        as={<TextField />}
        name="favCelebs"
        variant="outlined"
